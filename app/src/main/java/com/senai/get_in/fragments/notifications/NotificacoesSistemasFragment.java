...
public class NotificacoesSistemasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_notificacoes_sistemas, container, false);
    ...
    private void carregarNotificacoes() {
        // Deixaremos vazio para testar a mensagem de estado vazio
